package dev.smuggies.uwutils.minecraft.utils.regions
...
data class Region(
  ...
  /**
   * The center block of the [Region].
   */
  val center: Location
    get() = Location(
      world,
  ...
  /**
   * Fetches a random [Location] within the [Region].
   *
  ...
  /**
   * Fetches a random [Location] within the [Region] while keeping the [yRange] on the ground.
   *
   * @return A random [Location] within the [Region].
   */
